...
public class CreateStakeholderSer {
    ...
    public static void main(String args[])  {
        ...
        ObjectSolve ObjectSolve = new ObjectSolve();
        ObjectSolve.readFromSerFile();
        ObjectSolve.sortCustomersList();
        ObjectSolve.formatDob();
        ObjectSolve.printCustomers();
        ObjectSolve.sortSuppliersList();
        ObjectSolve.printSuppliers();
